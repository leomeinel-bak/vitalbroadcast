...
public final class VitalBroadcast extends JavaPlugin {
	...
	public void onEnable() {
		...
		Objects.requireNonNull(getCommand("broadcast")).setExecutor(new VitalBroadcastCmd());

		messages = new Messages();

		Bukkit.getLogger().info("VitalBroadcast v" + this.getDescription().getVersion() + " enabled");
		...
		Bukkit.getLogger().info("See https://github.com/TamrielNetwork/VitalBroadcast/blob/main/LICENSE for more details.");
	}

	@Override
	public void onDisable() {

		Bukkit.getLogger().info("VitalBroadcast v" + this.getDescription().getVersion() + " disabled");
	}
